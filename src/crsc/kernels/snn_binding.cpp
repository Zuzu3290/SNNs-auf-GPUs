// pybind11 binding layer: exposes snn_forward_cuda and snn_forward_profiled to Python.
// Kept in a separate file (snn_binding.cpp) so it compiles to snn_binding.o, avoiding
// the duplicate-symbol linker error that occurs when snn_forward.cpp and snn_forward.cu share a base name.
