"""Sinabs binding for the one shared model.
...
learning/main.py's FRAMEWORK_MODULES keeps resolving "sinabs" to a class, unchanged.
...
class SNN_SINABS(SNNModel):
    """Sinabs. See frameworks/snn_model.py for everything it does."""
