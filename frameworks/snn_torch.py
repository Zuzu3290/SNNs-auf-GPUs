"""snnTorch binding for the one shared model.
...
learning/main.py's FRAMEWORK_MODULES keeps resolving "torch" to a class, unchanged.
...
class SNN_TORCH(SNNModel):
    """snnTorch. See frameworks/snn_model.py for everything it does."""
