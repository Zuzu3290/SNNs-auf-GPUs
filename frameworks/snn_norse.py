"""Norse binding for the one shared model.
...
learning/main.py's FRAMEWORK_MODULES keeps resolving "norse" to a class, unchanged.
...
class SNN_NORSE(SNNModel):
    """Norse. See frameworks/snn_model.py for everything it does."""
